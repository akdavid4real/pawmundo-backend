...
export class InsuranceController {
  ...
  async create(@Request() req, @Body() createInsuranceDto: CreateInsuranceDto) {
    return this.insuranceService.create(req.user.id, createInsuranceDto);
  }
  ...
  async submitClaim(@Request() req, @Body() claimDto: InsuranceClaimDto) {
    return this.insuranceService.submitClaim(req.user.id, claimDto);
  }
  ...
  async getClaims(@Request() req, @Query('status') status?: string) {
    return this.insuranceService.getUserClaims(req.user.id, status);
  }
